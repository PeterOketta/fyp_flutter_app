        ...
        body: RefreshIndicator(
          ...
          child: ListView(
            children: <Widget>[
              ...
              TextButton(
                onPressed: () {
                  // Check if Bluetooth screen was the previous one
                  ...
                  // If Bluetooth screen was the previous one, navigate to enroll
                  if (isBluetoothScreen) {
                    ...
                    if (previousRoute == '/create-account') {
                      Navigator.of(context).pushNamed('/enroll'); // Go to enroll if previous page was account setup
                    } else if (previousRoute == '/') {
                      Navigator.of(context).pushNamed('/verification'); // Go to verification if previous page was welcome
                    } else {
                      // Add more conditions if needed for other pages
                      // You can also add a default route in case none of the conditions match
                      Navigator.of(context).pushNamed('/enroll');
                    }
                  }
                },
